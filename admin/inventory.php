...
if ($action == 'tg_stat' && isset($_GET['pid']) && is_numeric($_GET['pid'])) {
    ...
    zen_redirect(zen_href_link(FILENAME_INVENTORY, 'sort=' . $_GET['sort'] . '&active=' . $_GET['active'] . $cid_params, 'SSL'));
}
                            ...
                            <?php while ($prod_list && !$prod_list->EOF) {
                                ...
                                <tr class="dataTableRow" onmouseover="rowOverEffect(this)"
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?=  zen_href_link(FILENAME_INVENTORY, 'action=tg_stat' . '&pid=' . $prod_list->fields['products_id'] . $cid_params . '&sort=' . $_GET['sort'] .  '&active=' . $_GET['active'], 'SSL'); ?>">
